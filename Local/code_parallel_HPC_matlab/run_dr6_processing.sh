...
matlab -nodisplay -nosplash -nodesktop -r "process_dr6_parallel; exit"
'

# Count speakers and submit job
N_SPEAKERS=$(find /pasteur/appa/homes/mcampi/ASR_ANSD/Neurogram_Sim/SELECT/TRAIN/DR6/ -maxdepth 1 -mindepth 1 -type d | wc -l)
