...
%
%   Url: http://amtoolbox.org/amt-1.6.0/doc/defaults/arg_amt_configuration.php
...
v=['amt-' char(x')];
definput.keyvals.version = {v, 'amt-1.5.0', 'amt-1.4.0', 'amt-1.3.0', 'amt-1.2.0', 'amt-1.1.0', 'amt-1.0.0'};
