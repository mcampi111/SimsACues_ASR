...
f = h5py.File('TIMIT_neurogram_test.mat', 'r')
...
print("\nSaving results...")
scipy.io.savemat('TIMIT_neurogram_test_ANSD.mat', {'TIMIT_neurogram': TIMIT_neurogram_ANSD})

# Scale the perturbed matrix
TIMIT_neurogram_ANSD_scaled = sklearn.preprocessing.scale(TIMIT_neurogram_ANSD)
np.save('TIMIT_neurogram_test_ANSD_scaled.npy', TIMIT_neurogram_ANSD_scaled)
