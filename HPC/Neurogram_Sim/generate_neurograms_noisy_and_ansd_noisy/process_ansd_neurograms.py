...
def process_subset_of_neurograms(input_base, output_base, task_id, num_tasks):
    ...
    for dataset in ['TRAIN', 'TEST']:
        ...
        for file_path in task_files:
            try:
                ...
                output_file_path = os.path.join(output_base, relative_path)
                
                # Ensure output directory exists
                os.makedirs(os.path.dirname(output_file_path), exist_ok=True)
                
                # Replace _with_noise.mat with _with_noise_ansd.mat
                output_file_path = output_file_path.replace('_with_noise.mat', '_with_noise_ansd.mat')
...
def main():
    ...
    process_subset_of_neurograms(input_base, output_base, task_id, num_tasks)
