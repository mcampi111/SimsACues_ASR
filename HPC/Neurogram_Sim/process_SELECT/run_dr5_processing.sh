...
matlab -nodisplay -nosplash -nodesktop -r "process_dr5_parallel; exit"
'

# Count speakers and submit job
N_SPEAKERS=$(find /pasteur/appa/homes/mcampi/ASR_ANSD/Neurogram_Sim/SELECT/TRAIN/DR5/ -maxdepth 1 -mindepth 1 -type d | wc -l)
