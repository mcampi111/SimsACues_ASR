...
% Define directories
input_dir = '/pasteur/appa/homes/mcampi/ASR_ANSD/Neurogram_Sim/SELECT/TRAIN/DR5/';
...
% Create output DR5 directory if it doesn't exist
output_dr_path = fullfile(output_base_dir, 'DR5');
