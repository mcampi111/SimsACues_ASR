...
RESULTS_DIR = "/pasteur/helix/scratch/mcampi/results/ansd/noise/test"
MODEL_DIR = "results/ansd/noise"
...
def test_condition(test_info):
    ...
    try:
        ...
        # Create a readable test condition name from the file name
...
def main():
    ...
    log_message("Starting testing for ANSD noise model on ANSD noise data")
    ...
    with open(os.path.join(RESULTS_DIR, "summary.txt"), "w") as f:
        f.write("ANSD NOISE MODEL TESTING SUMMARY\n")
        f.write("==============================\n\n")
