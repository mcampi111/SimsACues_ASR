...
# Define paths
DATA_DIR = "TIMIT_Neuro_ANSD"
RESULTS_DIR = "/pasteur/helix/scratch/mcampi/results/ansd/silence/test"
MODEL_DIR = "results/ansd/silence"
...
test_files = [
    # Clean ANSD test data
    {'neurogram': 'TIMIT_neurogram_ansd_test_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'ansd_silence', 'Phonemes39consecutive_true_test_ansd_silence.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'ansd_silence', 'Phonemes39_position_index_true_test_ansd_silence.npy')},
    
    # Noisy ANSD test data
...
def test_condition(test_info):
    ...
    try:
        ...
        if test_name == "TIMIT_neurogram_ansd_test_scaled":
        ...
        combineModelCausalNN(
            ...
            filename_X1=test_data_path,  # FIXED: Using test_data_path instead of test_data
            filename_X2=test_data_path,  # FIXED: Using test_data_path instead of test_data
...
def main():
    ...
    log_message("Starting testing for ANSD silence model on ANSD data")
    ...
    with open(os.path.join(RESULTS_DIR, "summary.txt"), "w") as f:
        f.write("ANSD SILENCE MODEL TESTING SUMMARY\n")
        f.write("================================\n\n")
