...
def extract_phoneme_labels(data_dir, output_dir, dataset_type):
    """
    ...
    # Modified pattern to match files like: SA1_aa_14800_16835_neurogram_with_noise.mat
    ...
    phoneme_file = f"Phonemes39consecutive_true_{dataset_type}_wham.npy"
    position_file = f"Phonemes39_position_index_true_{dataset_type}_wham.npy"
    mapping_file = f"phoneme_mapping_{dataset_type}_wham.txt"
