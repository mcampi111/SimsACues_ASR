#!/bin/bash
#SBATCH --job-name=train_ansd_noise
#SBATCH --output=logs/train_ansd_noise_%j.out
#SBATCH --error=logs/train_ansd_noise_%j.err
...
# Run ANSD noise training
echo "Starting ANSD noise training at $(date)"
python3 train_ansd_noise.py

# Print completion time
echo "ANSD noise training completed at $(date)"
