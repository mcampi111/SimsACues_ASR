...
# Define file paths
NEUROGRAM_PATH = 'TIMIT_Neuro_ANSD/train/TIMIT_neurogram_ansd_train_with_noise_scaled.npy'
PHONEMES_PATH = 'Phonemes39_posindex_labels/train/ansd_noise/Phonemes39consecutive_true_train_ansd_noise.npy'
POSITIONS_PATH = 'Phonemes39_posindex_labels/train/ansd_noise/Phonemes39_position_index_true_train_ansd_noise.npy'
...
print("Complete ANSD Noise ASR training pipeline completed successfully!")
