...
OUTPUT_DIR = 'results/ansd/silence'
...
# Define file paths
NEUROGRAM_PATH = 'TIMIT_Neuro_ANSD/train/TIMIT_neurogram_ansd_train_scaled.npy'
PHONEMES_PATH = 'Phonemes39_posindex_labels/train/ansd_silence/Phonemes39consecutive_true_train_ansd_silence.npy'
POSITIONS_PATH = 'Phonemes39_posindex_labels/train/ansd_silence/Phonemes39_position_index_true_train_ansd_silence.npy'
...
print("Complete ANSD ASR training pipeline completed successfully!")
