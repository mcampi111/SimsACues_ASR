...
def extractBasicFeatures():
    saveAuditoryInformation( ms_per_seg = 2, dir_data = 'C:\Documents\ASR_Original\TIMIT\timit\TIMIT\TRAIN', fs = 16000) # not Mel scale in our case, performance similar to Mel
...
def runPhonemeInfo():
    savePhonemeInformation( ms_per_seg = 2, dir_data = 'C:\Documents\ASR_Original\TIMIT\timit\TIMIT\TRAIN', fs = 16000 )
    getPhonemeDict( dir_data = 'C:\Documents\ASR_Original\TIMIT\timit\TIMIT\TRAIN' )
...
def saveIndices():
    getIndexNonSa(ms_per_seg = 2, dir_data = 'C:\Documents\ASR_Original\TIMIT\timit\TIMIT\TRAIN', fs = 16000, split = 0.9) # prepare indices
    saveStartIndices( ms_per_seg = 2, dir_data = 'C:\Documents\ASR_Original\TIMIT\timit\TIMIT\TRAIN', fs = 16000, split = 0.9 )
