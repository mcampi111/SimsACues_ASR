...
# Define paths
DATA_DIR = "TIMIT_Neuro"
RESULTS_DIR = "/pasteur/helix/scratch/mcampi/results/healthy/silence/test"
MODEL_DIR = "results/healthy/silence"
...
test_files = [
    # Clean test data
    {'neurogram': 'TIMIT_neurogram_test_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_silence', 'Phonemes39consecutive_true_test_healthy_silence.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_silence', 'Phonemes39_position_index_true_test_healthy_silence.npy')},
    
    # Noisy test data
    {'neurogram': 'TIMIT_neurogram_test_with_noise_default_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39consecutive_true_test_default.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39_position_index_true_test_default.npy')},
     
    {'neurogram': 'TIMIT_neurogram_test_with_noise_snr_0_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39consecutive_true_test_snr0.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39_position_index_true_test_snr0.npy')},
     
    {'neurogram': 'TIMIT_neurogram_test_with_noise_snr_5_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39consecutive_true_test_snr5.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39_position_index_true_test_snr5.npy')},
     
    {'neurogram': 'TIMIT_neurogram_test_with_noise_snr_10_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39consecutive_true_test_snr10.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39_position_index_true_test_snr10.npy')},
     
    {'neurogram': 'TIMIT_neurogram_test_with_noise_snr_15_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39consecutive_true_test_snr15.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39_position_index_true_test_snr15.npy')},
     
    {'neurogram': 'TIMIT_neurogram_test_with_noise_snr_neg5_scaled.npy', 
     'phoneme_file': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39consecutive_true_test_snr-5.npy'),
     'position_index': os.path.join(PHONEMES_DIR, 'healthy_noise', 'Phonemes39_position_index_true_test_snr-5.npy')}
]
...
def test_condition(test_info):
    ...
    try:
        ...
        if test_name == "TIMIT_neurogram_test_scaled":
...
def main():
    ...
    log_message("Starting testing for healthy silence model on healthy data")
    ...
    # Sort conditions logically: silence first, then by SNR value
    def sort_key(condition):
        if condition == "silence":
            return -999  # Put silence first
        if condition == "default":
            return -99   # Put default second
    ...
    with open(os.path.join(RESULTS_DIR, "summary.txt"), "w") as f:
        f.write("HEALTHY SILENCE MODEL TESTING SUMMARY\n")
        f.write("====================================\n\n")
